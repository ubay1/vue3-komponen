...
export default defineConfig({
  shortcuts: [
    ...
    ['btn-transparent', 'bg-transparent border-none cursor-pointer p-0 hover:bg-transparent hover:opacity-80'],
  ...
  theme: {
    ...
    boxShadow: {
      insetBoxShadow: 'inset 0 -1px 1px rgba(33, 71, 41, 0.15),0 0.25rem 1.5rem rgba(255, 255, 255, 0.75)',
